...
func New() *Config {
	return &Config{
		...
		Resources: []*Resource{
			...
			{Kind: "github_repository_deploy_key", Keys: []string{"repository"}},
			...
			{Kind: "google_kms_crypto_key", Keys: []string{"key_ring", "name"}},
			{Kind: "google_kms_key_ring_iam_policy", Keys: []string{"key_ring_id"}},
			{Kind: "google_kms_key_ring_import_job", Keys: []string{"key_ring", "import_job_id"}},
			{Kind: "google_kms_key_ring", Keys: []string{"project", "location", "name"}},
			...
			{Kind: "google_pubsub_topic_iam_member", Keys: []string{"project", "topic", "role", "member"}},
			...
			{Kind: "google_service_account_iam_member", Keys: []string{"service_account_id", "role", "member"}},
			...
			{Kind: "google_storage_bucket_object", Keys: []string{"bucket", "name"}},
			...
			{Kind: "kubernetes_secret_v1", Keys: []string{"metadata.namespace", "metadata.name"}},
			...
			{Kind: "tls_private_key", Keys: []string{}},
